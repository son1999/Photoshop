...
OutFile "..\..\..\PhotoshopPortable\${APP}64Portable.exe"
Icon "${APP}.ico"
...
; WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\Adobe\Photoshop\60.0" "ApplicationPath" "$EXEDIR\${APPDIR}\"
; WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\Adobe\Photoshop\60.0\ApplicationPath" "" "$EXEDIR\${APPDIR}\"
; WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\Adobe\Photoshop\60.0" "PluginPath" "$EXEDIR\${APPDIR}\Plug-ins\"
; WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\Adobe\Photoshop\60.0\PluginPath" "" "$EXEDIR\${APPDIR}\Plug-ins\"

; WriteRegStr HKEY_CURRENT_USER "Software\Adobe\IAC" "UserID" "C75B90938DBED1BE83816F5B5364053"
...
; DeleteRegValue HKEY_LOCAL_MACHINE "SOFTWARE\Adobe\Photoshop\60.0" "ApplicationPath"
; DeleteRegValue HKEY_LOCAL_MACHINE "SOFTWARE\Adobe\Photoshop\60.0" "PluginPath"
; DeleteRegValue HKEY_LOCAL_MACHINE "SOFTWARE\Adobe\Photoshop\60.0\ApplicationPath" ""
; DeleteRegValue HKEY_LOCAL_MACHINE "SOFTWARE\Adobe\Photoshop\60.0\PluginPath" ""
